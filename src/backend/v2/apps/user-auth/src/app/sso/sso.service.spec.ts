...
import { PaginationResponseDto } from '@DefendStack-backend/dto';
        ...
        },
        {
          ...
          useValue: {
            ...
            decode: jest.fn().mockReturnValue({
              DefendStack_id: 'test_id',
              DefendStack_username: 'test_username',
              DefendStack_role: 'test_role',
            }),
            signAsync: jest.fn(),
            verifyAsync: jest.fn(),
          },
  ...
  describe('ssoLogin', () => {
    it('should handle SSO register', async () => {
      ...
      const userInfoResponse = {
        data: { email: 'test@example.com', DefendStack_role: 'admin' },
      };
      const user = {
        id: 1,
        username: 'test',
